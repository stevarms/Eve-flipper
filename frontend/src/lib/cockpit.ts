...
export const MAIN_TAB_META: Record<MainTabId, { labelKey: TranslationKey; fallback: string; group: "scan" | "tools" }> = {
  ...
  accumulate: { labelKey: "tabAccumulate", fallback: "Accumulate", group: "scan" },
  orders: { labelKey: "tabOrders", fallback: "Orders", group: "tools" },
  price_audit: { labelKey: "tabPriceAudit", fallback: "Price Audit", group: "tools" },
  plex: { labelKey: "tabPlex", fallback: "PLEX", group: "tools" },
  ...
  lp: { labelKey: "tabLPStore", fallback: "LP Store", group: "tools" },
...
export const WORKSPACE_META: Record<WorkspaceId, WorkspaceMeta> = {
  ...
  trade: {
    ...
    fallback: "Trade",
    icon: "TrendingUp",
    tabs: ["radius", "region", "station", "accumulate", "contracts", "orders", "fw", "lp", "plex", "optimizer", "edge"],
  },
  industry: {
    labelKey: "wsIndustry",
    fallback: "Industry",
  ...
  journal: {
    ...
    fallback: "Journal",
    icon: "BookOpen",
    tabs: ["trade_journal", "transactions", "wallet", "risk"],
  },
  intel: {
    labelKey: "wsIntel",
    fallback: "Intel",
